...
function init() {
    ...
    //wall
    var texture1 = new THREE.TextureLoader().load('wall.jpg');
    var texture2 = new THREE.TextureLoader().load('wall2.jpg');
    var texture3 = new THREE.TextureLoader().load('wall3.jpg');
    var texture4 = new THREE.TextureLoader().load('wall4.jpg');

    // materialSB = new THREE.MeshBasicMaterial({map: texture});

    geometry = new THREE.BoxGeometry(3.51, 0.1, 2.8);
